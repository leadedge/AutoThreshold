...
// ===============================================================
// LJ - Modified for PBO and some vertex shader extensions
// spout.zeal.co
// ===============================================================
...
void FFGLExtensions::InitARBShaderObjects()
{
  ...
  // LJ - vertex attribute support
  glGetAttribLocationARB = (glGetAttribLocationARBPROC)(unsigned)GetProcAddress("glGetAttribLocationARB");
  glVertexAttribPointerARB = (glVertexAttribPointerARBPROC)(unsigned)GetProcAddress("glVertexAttribPointerARB");
  glEnableVertexAttribArrayARB = (glEnableVertexAttribArrayARBPROC)(unsigned)GetProcAddress("glEnableVertexAttribArrayARB");
  glDisableVertexAttribArrayARB = (glDisableVertexAttribArrayARBPROC)(unsigned)GetProcAddress("glDisableVertexAttribArrayARB");
...
void FFGLExtensions::InitEXTFramebufferObject()
{
  ...
  {
	// LJ - PBO support
	glGenBuffers = (glGenBuffersPROC)(unsigned)GetProcAddress("glGenBuffers");
	glDeleteBuffers = (glDeleteBuffersPROC)(unsigned)GetProcAddress("glDeleteBuffers");
	glBindBuffer = (glBindBufferPROC)(unsigned)GetProcAddress("glBindBuffer");
	glBufferData = (glBufferDataPROC)(unsigned)GetProcAddress("glBufferData");
	glMapBuffer = (glMapBufferPROC)(unsigned)GetProcAddress("glMapBuffer");
	glUnmapBuffer = (glUnmapBufferPROC)(unsigned)GetProcAddress("glUnmapBuffer");
